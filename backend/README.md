...
## Project Structure
    ...
    ├── testapiautoconnect_118752  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_118752`
...
2. Clone this repo and `cd testapiautoconnect_118752`
